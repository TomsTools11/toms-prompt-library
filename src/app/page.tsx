    ...
    <div className="mx-auto max-w-6xl px-4 py-20">
      ...
      <section className="mb-20 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Link
            href="/skills"
            className="inline-flex items-center gap-2 rounded-pill border border-[var(--color-blue-primary)] px-7 py-3 text-sm font-medium text-[var(--color-blue-primary)] transition-all duration-150 hover:-translate-y-0.5 hover:bg-[var(--accent-light)] hover:shadow-card-hover"
          >
            Browse Skills
            <span aria-hidden="true">&rarr;</span>
          </Link>
